...
export const sendInvitation = async (
  ...
  //If we want to inivite users for signup. Note that if they try to create an account and an invitation is already sent, than an agency would not be created for them since the application allows one agency per email address
